...
. ├── .gitattributes # Enforces consistent line endings (LF) for all OS ├── .gitignore # Ignores junk files, logs, and venv ├── LICENSE # MIT License ├── README.md # You are here ├── requirements.txt # Desktop app Python dependencies ├── desktop-app/ # Desktop Python application (GUI, plotting) │ └── main.py └── sensor-firmware/ ├── code.py # Main CircuitPython sensor logic ├── settings.toml # Sensor settings └── lib/ # CircuitPython libraries (dependencies)
